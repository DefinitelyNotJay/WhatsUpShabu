            ...
            if ($row_count > 0) {
              ...
              while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
                ...
                <div class="flex justify-start items-center h-40 w-full bg-amber-200 gap-3 rounded-lg shadow-sm">
                  ...
                  <div class="flex w-3/12 h-full justify-end items-center p-10"><input type="checkbox" class="w-8 h-8"
                      id="<?php $menu_id ?>"></div>
                </div>
                <?php
              }
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="btn-close flex justify-center items-center font-bold" data-bs-dismiss="modal"
