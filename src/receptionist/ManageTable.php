            ...
            <div
                ...
                <div>
                    <div
                        ...
                        <p class="text-2xl font-semibold text-[#6A311D] table-number">A-01</p>
                    </div>
                ...
                <div>
                    <div
                        ...
                        <p class="text-2xl font-semibold text-[#6A311D] table-number">A-02</p>
                    </div>
                    <div class="bg-[#FA5D2A] flex flex-col justify-between rounded-b-xl w-full h-5/6  p-2">
                        <div class="top text-white flex flex-col gap-2">
                            ...
                            <div class="flex gap-2 ml-6">
                                ...
                                <p class="font-semibold text-lg">โต๊ะกำลังใช้งาน</p>
                            </div>
                            <div class="flex gap-2 ml-6">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <p class="font-semibold text-lg">3/4</p>
                            </div>
                        </div>
                        <div class="flex flex-col gap-2">
                            <hr>
                            <div class="bottom flex justify-between items-end w-full ">
                                <div class="flex gap-2">
                                    ...
                                    <p class="text-lg font-semibold text-white">1:05:56</p>
                                </div>
                                <button
