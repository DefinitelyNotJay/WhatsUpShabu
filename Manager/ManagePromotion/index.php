        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 main-content">
                ...
                <div class="custom-div1 d-flex ">
                    <div class="option-bar d-flex align-items-center shadow p-3 mb-5 rounded" data-bs-toggle="modal" data-bs-target="#addProModal">
                        ...
                        <h5 class="fw-bold mt-2">เพิ่มโปรโมชั่น</h5>
                    </div>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        foreach ($promotionByStatus as $Status => $promotions) {
                            ...
                            foreach ($promotions as $promotion) {
                                ...
                                echo '<div class="menu d-flex align-items-center shadow rounded '. $inactive .'">';
                                ...
                                echo '<div class="menu-option d-flex align-items-center shadow rounded mr-1 button-edit data-toggle="modal" data-target="#editProModal" data-pro-id="' . $promotion["ID"] . '">';
                                ...
                                echo '<div class="menu-option d-flex align-items-center shadow rounded button-delete data-toggle="modal" data-target="#deleteProModal" data-pro-id="' . $promotion["ID"] . '">';
                ...
                ?>
                            ...
                            <div class="menu d-flex align-items-center shadow rounded">
                                <div class="content-menu">
                                    ...
                                    <div class="menu-edit d-flex mb-3">
                                        <div class="menu-option d-flex align-items-center shadow rounded mr-1 button-edit">
                                        ...
                                        <div class="menu-option d-flex align-items-center shadow rounded button-delete">
                    ...
                    <div class="container-fuild category">
                        ...
                        <div class="container-menu d-flex flex-wrap">
                            <!-- 1 menu -->
                            <div class="menu d-flex align-items-center shadow rounded not">
                                <div class="content-menu">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="add-pro" name="add-pro" class="add-menu-option d-flex align-items-center shadow rounded btn-confirm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="edit-pro" name="edit-pro" class="add-menu-option d-flex align-items-center shadow rounded btn-confirm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check-circle mr-1"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m9 11 3 3L22 4"/></svg>
                            <h6 class="fw-bold mt-2">ยืนยัน</h6>
                        </button>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="delete-pro" name="delete-pro" class="add-menu-option d-flex align-items-center shadow rounded btn-confirm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check-circle mr-1"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m9 11 3 3L22 4"/></svg>
                            <h6 class="fw-bold mt-2">ยืนยัน</h6>
                        </button>
                    </div>
